...
public class Dames {
	...
	static int seleccionarfitxan(String tablero[][], int fila, String columna ) {
		...
		switch(columna) {
			case "A": columnaparse=0;
				break;
			case "B": columnaparse=1;
				break;
			case "C": columnaparse=2;
				break;
			case "D": columnaparse=3;
				break;
			case "E": columnaparse=4;
				break;
			case "F": columnaparse=5;
				break;
			case "G": columnaparse=6;
				break;
			case "H": columnaparse=7;
				break;
			default:
					...
					if((filamovida <= 7 && filamovida >= 0) && (columnamovida <= 7 && columnamovida >= 0)){
						if (tablero[filamovida][columnamovida] != "█◙█"){
							if(tablero[filamovida][columnamovida] == "█◘█"){
								...
								if(((filamovida2 <= 7 && filamovida2 >= 0) && (columnamovida2 <= 7 && columnamovida2 >= 0)) && tablero[filamovida2][columnamovida2] == "███"){									//comer
									tablero[filamovida][columnamovida] = "███";
									tablero[fila][columnaparse] = "███";
									tablero[filamovida2][columnamovida2] = "█◙█";
									return 2;
									System.out.println("return: " + retorn);
